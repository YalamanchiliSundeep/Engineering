...
if brp_file and uploaded_file:
    with st.spinner('Processing the NDAs...'):
        ...
        comparison_text = ""  # Initialize an empty string to collect all the comparison results
        ...
        for idx, comparison in enumerate(gemini_comparisons):
            ...
            # Append the data to the comparison_text
            comparison_text += f"**BRP Clause Title:** {comparison['BRP Clause Title'] if comparison['BRP Clause Title'] else 'N/A'}\n"
            comparison_text += f"**{uploaded_file_name} Match Title:** {comparison['Uploaded NDA Match Title'] if comparison['Uploaded NDA Match Title'] else 'N/A'}\n"
            comparison_text += f"**Deviation:** {comparison['Deviation']}\n\n"
